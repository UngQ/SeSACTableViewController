//
//  StepTwoPopularCityCollectionViewController.swift
...
class StepTwoPopularCityCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        let xib = UINib(nibName: "StepTwoCollectionViewCell", bundle: nil)
        collectionView.register(xib, forCellWithReuseIdentifier: "StepTwoCollectionViewCell")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "StepTwoCollectionViewCell", for: indexPath) as! StepTwoCollectionViewCell
        ...
        //원형 이미지 만들기, 정사각형이니 반지름은 셀 넓이의 /2
        let spacing: CGFloat = 24
